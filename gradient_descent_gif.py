...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'batch':
        ...
        imageio.mimsave('./stochastic_GD.gif',[plot_for_offset(i, 20) for i in stochastic_gradient_descent(X,y)], fps=3)
    else:
